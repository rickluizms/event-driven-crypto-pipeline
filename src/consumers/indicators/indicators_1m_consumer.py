...
class Indicators1mConsumer:
    ...
    async def _handle(self, message: dict) -> None:
        with message_processing_duration.labels(component="indicators_1m").time():
            ...
            if indicators:
                indicators_emitted_total.labels(symbol=candle.symbol, interval="1m").inc(len(indicators))
                logger.info(
